...
from src.models import GeminiChatbot, ConversationMessage
...
def test_gemini_bot(gemini_chatbot: GeminiChatbot) -> None:
    ...
    assert gemini_chatbot.system_prompt == "You are in a test program and you are called GeminiTestBot1 - You are a helpful assistant."
