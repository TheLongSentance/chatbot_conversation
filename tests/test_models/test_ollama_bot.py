...
from src.models import OllamaChatbot, ConversationMessage
...
def test_ollama_bot(ollama_chatbot: OllamaChatbot) -> None:
    ...
    assert ollama_chatbot.system_prompt == "You are in a test program and you are called OllamaTestBot1 - You are a helpful assistant."
